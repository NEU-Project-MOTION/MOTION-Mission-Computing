...
class VisionBridge : public rclcpp::Node
{
  public:
    ...
    : Node("vision_bridge"){
        ...
        odom_sub_ = this->create_subscription<nav_msgs::msg::Odometry>("/drone/T265/pose/sample", sensor_qos, std::bind(&VisionBridge::OdomInCallback, this, std::placeholders::_1));
